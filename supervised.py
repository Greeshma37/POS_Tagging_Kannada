...
tags = ['NN','PRP','ADJ','ADV','PRE','VER','CON','UNK','INT','NaN']
#--------------------------------------------------------------------------
...
def main():
	...
	filepath = ["./data/kannada_training.txt", "./data/kannada_training1.txt"]
	...
	file_output = codecs.open("./output/"+ language[int(sys.argv[1])] +"_tags.txt", 'w', 'utf-8')
	file_output.close()
	...
	for j in range(len(test_input)):
		...
		file_output = codecs.open("./output/"+ language[int(sys.argv[1])] +"_tags.txt", 'a', 'utf-8')
	...
	print("\nKindly check ./output/" + language[int(sys.argv[1])] + "_tags.txt file for POS tags.")
...
if __name__ == "__main__":
	try:
		...
		if len(sys.argv) == 3:
			...
			print("Usage: python supervised.py <training_file_path> <test_file_path>")
			print("Example: python supervised.py 1 ./data/kannada_testing_sentences_100.txt")
			print("More Info: Check ./Readme for detailed information")
